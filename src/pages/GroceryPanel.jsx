...
export default function GroceryPanel() {
  ...
  const [formData, setFormData] = useState({ name: '', price: '', category: 'grocery', subcategory: '', image: '', in_stock: true });
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const filePath = `grocery/${fileName}`;
  ...
  const openModal = (product = null) => {
    if (product) {
      ...
      setFormData({ name: '', price: '', category: 'grocery', subcategory: '', image: '', in_stock: true });
    }
    setIsModalOpen(true);
  };
    ...
    <div className="p-4 bg-slate-50 min-h-screen pb-24">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-5 mb-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-800">Grocery Dashboard</h2>
